! function (e, t) {
        ...
        se = function (e, n) {
            ...
            if (t) {
                ...
                var r = function () {
                    ...
                    }), ce.keydownHandlerAdded = !1), o.parentNode && o.parentNode.removeChild(o), N([document.documentElement, document.body], [I.shown, I["height-auto"], I["no-backdrop"], I["toast-shown"], I["toast-column"]]), L() && (null !== y.previousBodyPadding && (document.body.style.paddingRight = y.previousBodyPadding, y.previousBodyPadding = null), function () {
                ...
                return new Promise(function (r) {
                    ! function t(n, o) {
                        n < ye.length ? (document.body.setAttribute("data-swal2-queue-step", n), i(ye[n]).then(function (e) {
                            void 0 !== e.value ? (c.push(e.value), t(n + 1, o)) : (a(), r({
                                dismiss: e.dismiss
                            }))
                        })) : (a(), r({
                            value: c
    ...
    var Ee, Oe = Object.freeze({
        ...
        _main: function (e) {
            ...
            return new Promise(function (t, n) {
                var o = function (e) {
                        q.closePopup(T.onClose, T.onAfterClose), T.useRejections ? t(e) : t({
                            value: e
                        })
                    },
                    s = function (e) {
                        q.closePopup(T.onClose, T.onAfterClose), T.useRejections ? n(e) : t({
                            dismiss: e
                        })
                    },
                    u = function (e) {
                ...
                ce.keydownHandlerAdded && (ce.keydownTarget.removeEventListener("keydown", ce.keydownHandler, {
                    ...
                    capture: ce.keydownListenerCapture
                }), ce.keydownHandlerAdded = !0), L.enableButtons(), L.hideLoading(), L.resetValidationError(), T.toast && (T.input || T.footer || T.showCloseButton) ? D(document.body, I["toast-column"]) : N(document.body, I["toast-column"]);
    ...
    }), Le.DismissReason = e, Le.noop = function () {}, Le.version = "7.26.27";
