...
! function () {
    ...
    function k(n) {
        for (var t = 1; t < arguments.length; t++) {
            ...
            t % 2 ? a(Object(i), !0).forEach(function (t) {
                var a, e;
                a = n, t = i[e = t], e in a ? Object.defineProperty(a, e, {
                    value: t,
                    enumerable: !0,
                    configurable: !0,
                    writable: !0
                }) : a[e] = t
            }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(n, Object.getOwnPropertyDescriptors(i)) : a(Object(i)).forEach(function (t) {
    ...
    try {
        "undefined" != typeof window && (o = window), "undefined" != typeof document && (s = document), "undefined" != typeof MutationObserver && (c = MutationObserver), "undefined" != typeof performance && (f = performance)
    } catch (t) {}
    var u = (o.navigator || {}).userAgent,
        ...
        U = [].concat(l(Object.keys(I)), ["2xs", "xs", "sm", "lg", "xl", "2xl", "beat", "border", "fade", "beat-fade", "bounce", "flip-both", "flip-horizontal", "flip-vertical", "flip", "fw", "inverse", "layers-counter", "layers-text", "layers", "li", "pull-left", "pull-right", "pulse", "rotate-180", "rotate-270", "rotate-90", "rotate-by", "shake", "spin-pulse", "spin-reverse", "spin", "stack-1x", "stack-2x", "stack", "ul", W.GROUP, W.SWAP_OPACITY, W.PRIMARY, W.SECONDARY]).concat(s.map(function (t) {
            return "".concat(t, "x")
    ...
    function at(t) {
        return t.size !== G.size || t.x !== G.x || t.y !== G.y || t.rotate !== G.rotate || t.flipX || t.flipY
    }
    ...
    function rt() {
        h.removeEventListener("DOMContentLoaded", rt), ct = 1, st.map(function (t) {
            return t()
        })
    }
    var ot = d[o],
    ...
    function lt(t) {
        var e, a = t.tag,
            ...
            n = t.children,
            n = void 0 === n ? [] : n;
        return "string" == typeof t ? $(t) : "<".concat(a, " ").concat((e = i, Object.keys(e || {}).reduce(function (t, a) {
            return t + "".concat(a, '="').concat($(e[a]), '" ')
        }, "").trim()), ">").concat(n.map(lt).join(""), "</").concat(a, ">")
    }
    ...
    function mt(t, a, e, n) {
        for (var i, r, o = Object.keys(t), s = o.length, c = void 0 !== n ? dt(a, n) : a, f = void 0 === e ? (i = 1, t[o[0]]) : (i = 0, e); i < s; i++) f = c(f, t[r = o[i]], r, t);
        return f
    }
    var dt = function (i, r) {
    ...
    function pt(t, a, e) {
        var n = (2 < arguments.length && void 0 !== e ? e : {}).skipHooks,
            e = void 0 !== n && n,
            n = vt(a);
        "function" != typeof ot.hooks.addPack || e ? ot.styles[t] = k(k({}, ot.styles[t] || {}), n) : ot.hooks.addPack(t, vt(a)), "fas" === t && pt("fa", a)
    }
    var gt = ot.styles,
        ht = ot.shims,
        yt = Object.values(L),
    ...
    function Lt(t, a) {
        var a = (1 < arguments.length && void 0 !== a ? a : {}).skipLookups,
            ...
            t = t.reduce(function (t, a) {
                ...
                return gt[a] ? (a = yt.includes(a) ? Y[a] : a, i = a, t.prefix = a) : -1 < Ct.indexOf(a) ? (i = a, t.prefix = It(a)) : e ? t.iconName = e : a !== X.replacementClass && t.rest.push(a), !n && t.prefix && t.iconName && (e = "fa" === i ? jt(t.iconName) : {}, a = Et(t.prefix, t.iconName), e.prefix && (i = null), t.iconName = e.iconName || a || t.iconName, t.prefix = e.prefix || t.prefix, "far" !== t.prefix || gt.far || !gt.fas || X.autoFetchSvg || (t.prefix = "fas")), t
            }, Mt());
    ...
    var c = function () {
            ...
            }]) && i(a.prototype, e), n && i(a, n), Object.defineProperty(a, "prototype", {
                writable: !1
            }), t
        }(),
        d = [],
    ...
    function Dt(t, a) {
        ...
        return (Yt[t] || []).forEach(function (t) {
    ...
    var Ut = new c,
        _t = {
            ...
            dom: {
                i2svg: function () {
                    ...
                    return p ? (Ft("beforeI2svg", t), Ht("pseudoElements2svg", t), Ht("i2svg", t)) : Promise.reject("Operation requires a DOM of some kind.")
                },
                watch: function () {
                    var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {},
                        a = t.autoReplaceSvgRoot;
                    !1 === X.autoReplaceSvg && (X.autoReplaceSvg = !0), X.observeMutations = !0, ft(function () {
                        Bt({
            ...
            parse: {
                icon: function (t) {
                    ...
                    if ("object" === n(t) && t.prefix && t.iconName) return {
                        prefix: t.prefix,
                    ...
                    if ("string" == typeof t && (-1 < t.indexOf("".concat(X.familyPrefix, "-")) || t.match(R))) {
                        a = Lt(t.split(" "), {
                            skipLookups: !0
                        });
                        return {
        ...
        Bt = function () {
            var t = (0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}).autoReplaceSvgRoot,
                t = void 0 === t ? h : t;
            (0 < Object.keys(ot.styles).length || X.autoFetchSvg) && p && X.autoReplaceSvg && _t.dom.i2svg({
                node: t
            })
        };
    ...
    function qt(t) {
        var a = t.icons,
            ...
            t = b.height,
            m = "fak" === i,
            b = [X.replacementClass, r ? "".concat(X.familyPrefix, "-").concat(r) : ""].filter(function (t) {
        ...
        var v, p, g, h, y, t = k(k({}, b), {}, {
            ...
            n = n.found && e.found ? Ht("generateAbstractMask", t) || {
                children: [],
                attributes: {}
            ...
            e = n.children,
            n = n.attributes;
        return t.children = e, t.attributes = n, s ? (p = (v = t).prefix, g = v.iconName, h = v.children, y = v.attributes, v = !0 === (v = v.symbol) ? "".concat(p, "-").concat(X.familyPrefix, "-").concat(g) : v, [{
            tag: "svg",
            attributes: {
                style: "display: none;"
            },
        ...
        }]) : (g = (p = t).children, y = p.main, v = p.mask, h = p.attributes, t = p.styles, at(p = p.transform) && y.found && !v.found && (v = y.width / y.height / 2, y = .5, h.style = tt(k(k({}, t), {}, {
    ...
    function Qt(i, r) {
        var o = r;
        return "fa" === r && null !== X.styleDefault && (r = kt), new Promise(function (t, a) {
            var e, n;
            Ht("missingIconAbstract");
            if ("fa" === o && (n = jt(i) || {}, i = n.iconName || i, r = n.prefix || r), i && r && Gt[r] && Gt[r][i]) return t(Kt(Gt[r][i]));
            e = i, n = r, j || X.showMissingIcons || !e || console.error('Icon with name "'.concat(e, '" and prefix "').concat(n, '" is missing.')), t(k(k({}, Jt), {}, {
                icon: X.showMissingIcons && i && Ht("missingIconAbstract") || {}
            }))
        })
    }
    ...
    function $t(t) {
        ta.mark("".concat(aa, " ").concat(t, " ends")), ta.measure("".concat(aa, " ").concat(t), "".concat(aa, " ").concat(t, " begins"), "".concat(aa, " ").concat(t, " ends"))
    }
    var ta = X.measurePerformance && u && u.mark && u.measure ? u : {
            mark: Zt,
            measure: Zt
        },
        aa = 'FA "6.1.1"',
        ea = {
            begin: function (t) {
                return ta.mark("".concat(aa, " ").concat(t, " begins")),
                    function () {
                        return $t(t)
                    }
            },
    ...
    var sa = {
        replace: function (t) {
            ...
            }), null === a.getAttribute(A) && X.keepOriginalSource ? (t = h.createComment((t = " ".concat((t = a).outerHTML, " "), t = "".concat(t, "Font Awesome fontawesome.com "))), a.parentNode.replaceChild(t, a)) : a.remove())
        },
        nest: function (t) {
            var a = t[0],
                e = t[1];
    ...
    function fa(e, t) {
        ...
        0 === e.length ? n() : (X.mutateApproach === z ? g.requestAnimationFrame || ca : ca)(function () {
    ...
    function ba(t) {
        var r, o, a, s;
        b && X.observeMutations && (a = t.treeCallback, r = void 0 === a ? na : a, a = t.nodeCallback, o = void 0 === a ? na : a, a = t.pseudoElementsCallback, s = void 0 === a ? na : a, t = void 0 === (t = t.observeMutationsRoot) ? h : t, da = new b(function (t) {
            var i;
            la || (i = kt, Q(t).forEach(function (t) {
                var a, e, n;
    ...
    function va(t) {
        var a = t.getAttribute("data-prefix"),
            ...
            i = Lt(Z(t));
        return i.prefix || (i.prefix = kt), a && e && (i.prefix = a, i.iconName = e), i.iconName && i.prefix || i.prefix && 0 < n.length && (i.iconName = (e = i.prefix, n = t.innerText, (xt[e] || {})[n] || zt(i.prefix, bt(t.innerText)))), i
    }
    ...
    function pa(t, a) {
        var e = 1 < arguments.length && void 0 !== a ? a : {
            ...
            r = n.prefix,
            o = n.rest,
            s = (a = Q((s = t).attributes).reduce(function (t, a) {
                return "class" !== t.name && "style" !== t.name && (t[a.name] = a.value), t
            }, {}), n = s.getAttribute("title"), s = s.getAttribute("data-fa-title-id"), X.autoA11y && (n ? a["aria-labelledby"] = "".concat(X.replacementClass, "-title-").concat(s || J()) : (a["aria-hidden"] = "true", a.focusable = "false")), a),
    ...
    function ha(t) {
        var a = "nest" === X.autoReplaceSvg ? pa(t, {
            styleParser: !1
        }) : pa(t);
        return ~a.extra.classes.indexOf(T) ? Ht("generateLayersText", t, a) : Ht("generateSvgReplacementMutation", t, a)
    }
    ...
    function ya(t) {
        ...
        var a = h.documentElement.classList,
            ...
            o = [".".concat(T, ":not([").concat(A, "])")].concat(e.map(function (t) {
    ...
    function wa(t) {
        ...
        if (t) {
            ...
            return Xt(k({
                ...
                return Ft("beforeDOMElementCreation", {
                    iconDefinition: t,
                    params: a
                }), X.autoA11y && (s ? l["aria-labelledby"] = "".concat(X.replacementClass, "-title-").concat(c || J()) : (l["aria-hidden"] = "true", l.focusable = "false")), qt({
                    icons: {
                        main: Kt(b),
                        mask: r ? Kt(r.icon) : {
                            found: !1,
            ...
            provides: function (t) {
                t.i2svg = function (t) {
                    ...
                    var a, e = t.children,
                        ...
                        r = t.transform,
                        t = tt(t.styles);
                    return 0 < t.length && (n.style = t), at(r) && (a = Ht("generateAbstractTransformGrouping", {
                        main: i,
                        transform: r,
                ...
                return {
                    counter: function (i) {
                        ...
                        return Xt({
                            ...
                            }), 0 < (n = tt(n.styles)).length && (t.style = n), (n = []).push({
                                tag: "span",
                                attributes: t,
                                children: [a]
                            }), e && n.push({
            ...
            provides: function (t) {
                t.generateLayersText = function (t, a) {
                    var e, n = a.title,
                        ...
                        o = null,
                        s = null;
                    return y && (e = parseInt(getComputedStyle(t).fontSize, 10), o = (a = t.getBoundingClientRect()).width / e, s = a.height / e), X.autoA11y && !n && (r.attributes["aria-hidden"] = "true"), Promise.resolve([t, Vt({
                        content: t.innerHTML,
                        width: o,
                        height: s,
                        transform: i,
    ...
    function Oa(b, v) {
        ...
        return new Promise(function (e, t) {
            ...
            var n, i, r, o, a, s, c, f = Q(b.children).filter(function (t) {
            ...
            u && "none" !== d && "" !== d ? (s = l.getPropertyValue("content"), n = ~["Solid", "Regular", "Light", "Thin", "Duotone", "Brands", "Kit"].indexOf(u[2]) ? I[u[2].toLowerCase()] : F[m], a = (d = (d = (a = s).replace(xa, ""), l = 0, s = (m = d).length, c = 55296 <= (a = m.charCodeAt(l)) && a <= 56319 && l + 1 < s && 56320 <= (c = m.charCodeAt(l + 1)) && c <= 57343 ? 1024 * (a - 55296) + c - 56320 + 65536 : a, a = Aa[0] <= c && c <= Aa[1], {
                value: bt((c = 2 === d.length && d[0] === d[1]) ? d[0] : d),
                isSecondary: a || c
            })).value, c = d.isSecondary, d = u[0].startsWith("FontAwesome"), u = zt(n, a), i = u, d && (a = Ot[d = a], d = zt("fas", d), (d = a || (d ? {
                prefix: "fas",
                iconName: d
            } : null) || {
                prefix: null,
                iconName: null
            }).iconName && d.prefix && (u = d.iconName, n = d.prefix)), !u || c || f && f.getAttribute(C) === n && f.getAttribute(P) === i ? e() : (b.setAttribute(p, i), f && b.removeChild(f), (o = (r = {
                iconName: null,
                title: null,
                titleId: null,
                prefix: null,
            ...
            }).extra).attributes[O] = v, Qt(u, n).then(function (t) {
                var a = qt(k(k({}, r), {}, {
                        icons: {
                            main: t,
                            mask: Mt()
                ...
                "::before" === v ? b.insertBefore(t, b.firstChild) : b.appendChild(t), t.outerHTML = a.map(lt).join("\n"), b.removeAttribute(p), e()
            }).catch(t))) : e()
        })
    }
    ...
    function Ca(t) {
        return !(t.parentNode === document.head || ~E.indexOf(t.tagName.toUpperCase()) || t.getAttribute(O) || t.parentNode && "svg" === t.parentNode.tagName)
    }

    function Pa(i) {
        if (p) return new Promise(function (t, a) {
            var e = Q(i.querySelectorAll("*")).filter(Ca).map(Na),
                n = ea.begin("searchPseudoElements");
            ua(), Promise.all(e).then(function () {
                n(), ma(), t()
            }).catch(function () {
                n(), ma(), a()
            })
    ...
    Ma = {
            ...
            hooks: function () {
                return {
                    ...
                    watch: function (t) {
                        ...
                        za ? ma() : ba(Dt("mutationObserverCallbacks", {
                ...
                return {
                    parseNodeAttributes: function (t, a) {
                        var e = a.getAttribute("data-fa-mask"),
                            e = e ? Lt(e.split(" ").map(function (t) {
                                return t.trim()
                            })) : Mt();
                        return e.prefix || (e.prefix = kt), t.mask = e, t.maskId = a.getAttribute("data-fa-mask-id"), t
                    }
                }
            },
            provides: function (t) {
        ...
        }], Yt = {}, Object.keys(Rt).forEach(function (t) {
            -1 === Tt.indexOf(t) && delete Rt[t]
        }), d.forEach(function (t) {
            var a, e = t.mixout ? t.mixout() : {};
            Object.keys(e).forEach(function (a) {
                "function" == typeof e[a] && (Ma[a] = e[a]), "object" === n(e[a]) && Object.keys(e[a]).forEach(function (t) {
        ...
        function (t) {
            ...
            v && (g.FontAwesome || (g.FontAwesome = _t), ft(function () {
                Bt(), Ft("bootstrap")
            })), ot.hooks = k(k({}, ot.hooks), {}, {
