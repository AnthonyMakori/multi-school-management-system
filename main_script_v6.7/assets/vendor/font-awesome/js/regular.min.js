...
! function () {
    ...
    var z = (C.navigator || {}).userAgent,
        ...
        L = C,
        V = c;
    L.document, V.documentElement && V.head && "function" == typeof V.addEventListener && V.createElement, ~M.indexOf("MSIE") || M.indexOf("Trident/");
    ...
    L = L || {};
    L[h] || (L[h] = {}), L[h].styles || (L[h].styles = {}), L[h].hooks || (L[h].hooks = {}), L[h].shims || (L[h].shims = []);
    var f = L[h];
    ...
    function n(C, c, z) {
        var M = (2 < arguments.length && void 0 !== z ? z : {}).skipHooks,
            z = void 0 !== M && M,
            M = t(c);
        "function" != typeof f.hooks.addPack || z ? f.styles[C] = l(l({}, f.styles[C] || {}), M) : f.hooks.addPack(C, t(c)), "fas" === C && n("fa", c)
    }
    var i = {
