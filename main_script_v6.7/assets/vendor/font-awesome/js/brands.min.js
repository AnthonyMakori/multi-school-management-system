...
! function () {
    ...
    var l = (c.navigator || {}).userAgent,
        ...
        m = c,
        v = z;
    m.document, v.documentElement && v.head && "function" == typeof v.addEventListener && v.createElement, ~h.indexOf("MSIE") || h.indexOf("Trident/");
    ...
    m = m || {};
    m[s] || (m[s] = {}), m[s].styles || (m[s].styles = {}), m[s].hooks || (m[s].hooks = {}), m[s].shims || (m[s].shims = []);
    var L = m[s];
    ...
    function r(c, z, l) {
        var h = (2 < arguments.length && void 0 !== l ? l : {}).skipHooks,
            l = void 0 !== h && h,
            h = f(z);
        "function" != typeof L.hooks.addPack || l ? L.styles[c] = C(C({}, L.styles[c] || {}), h) : L.hooks.addPack(c, f(z)), "fas" === c && r("fa", z)
    }
    var t = {
