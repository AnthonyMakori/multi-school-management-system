...
a = this, l = function () {
    ...
    var e = (a.navigator || {}).userAgent,
        ...
        n = a,
        f = l;
    n.document, f.documentElement && f.head && "function" == typeof f.addEventListener && f.createElement, ~r.indexOf("MSIE") || r.indexOf("Trident/");
    ...
    n = n || {};
    n[t] || (n[t] = {}), n[t].styles || (n[t].styles = {}), n[t].hooks || (n[t].hooks = {}), n[t].shims || (n[t].shims = []);
    var b = n[t],
        c = [
